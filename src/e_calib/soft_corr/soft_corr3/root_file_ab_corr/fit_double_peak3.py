...
f = root.TFile('run2079_ab_corr.root')
...
f1 = root.TF1('f1', 'gaus(0)+gaus(3)+[6]', 163.5, 169)
f1.SetParameter(0, 1000)
f1.SetParameter(1, 165)
f1.SetParameter(2, 0.8)
f1.SetParameter(3, 500)
f1.SetParameter(4, 168)
f1.SetParameter(5, 0.8)
f1.SetParameter(6, 0)

f2 = root.TF1('f2', 'gaus(0)+gaus(3)+[6]', 163.5, 169)
f2.SetParameter(0, 1000)
f2.SetParameter(1, 165)
f2.SetParameter(2, 0.8)
f2.SetParameter(3, 500)
f2.SetParameter(4, 168)
f2.SetParameter(5, 0.8)
f2.SetParameter(6, 0)

f3 = root.TF1('f3', 'gaus(0)+gaus(3)+[6]', 163.5, 169)
f3.SetParameter(0, 1000)
f3.SetParameter(1, 165)
f3.SetParameter(2, 0.8)
f3.SetParameter(3, 500)
f3.SetParameter(4, 168)
f3.SetParameter(5, 0.8)
f3.SetParameter(6, 0)

f4 = root.TF1('f4', 'gaus(0)+gaus(3)+[6]', 163.5, 169)
f4.SetParameter(0, 1000)
f4.SetParameter(1, 165)
f4.SetParameter(2, 0.8)
f4.SetParameter(3, 500)
f4.SetParameter(4, 168)
