...
struct vdcdata lasfx,lasfu,lasrx,lasru;
int posids;
...
double fppos[2][3];   /* position on focal plane by one chamber */
                      /* [0][0-2] position by GRFR */
                      /* [1][0-2] position by GRRE */

double hppos[2];     /* position on Hydrogen forcal plane by one chamber */
                     /* [0] by GRFR, [1] by GRRE */

double thsimp[2][2];   /* theta plane by one chamber */
double thcsimp[2][2];  /* theta plane by one chamber after correction */
                      /* [0][0] theta_x by GRFR */
                      /* [0][1] theta_y by GRFR */
                      /* [1][0] theta_x by GRRE */
                      /* [1][1] theta_y by GRRE */

double exsimp[2];    /* excitation energy by one chamber */
                     /* [0] by GRFR, [1] by GRRE */
