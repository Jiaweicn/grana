...
switch(grcr.igrmode){
 case 0:
   ...
   break;
 case 1:
   //   vdcpos[9][1]-=1.5; /* E308 Nov 2010 */
   vdcpos[9][1]-=3.4; /* E308 Nov 2010 */
...
//rf_c=feret_gr[4]-0.044161*vdcpos[9][0]-26.557*theta_x[1];
rf_c=feret_gr[4]-0.044*vdcpos[9][0]-24*theta_x[1];
